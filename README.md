# Kompresija Izvora - Hafmanov Algoritam i LZV u C++-u

Konzolna aplikacija u C++-u koja implementira kompresiju binarnih sekvenci generisanih **Markovljevim izvorom** korišćenjem dva algoritma: **Hafmanovog kodovanja** (sa prosirenjima do 5. reda) i **LZV (Lempel-Ziv-Welch) kompresije**.
...
2. **Hafmanovo kodovanje** - standardno kodovanje simbola 0 i 1 na osnovu izmerenih verovatnoća iz generisane sekvence
3. **Hafmanovo kodovanje sa prosirenjima** - 2., 3., 4. i 5. prosirenje (kombinacije simbola kao novi simboli abecede)
...
| Fajl | Sadržaj |
|------|---------|
| `stablo.h / stablo.cpp` | Binarno stablo za Hafmanovo kodovanje (`Cvor`, `Stablo`) |
...
- Hafmanov algoritam se primenjuje na ovaj prošireni skup
